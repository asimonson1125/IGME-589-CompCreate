function meatballs()
    ...
    scatter(behindX, behindY, 10, color, 'filled', 'SizeData', dotsize);
    ...
    scatter(behindXo, behindYo, 10, outercolor, 'filled', 'SizeData', dotsize);
    ...
    scatter(frontX, frontY, 10, color, 'filled', 'SizeData', dotsize);
    % plot_glow(frontX, frontY, color)

    frontXo = xo(zo >= 0);
    frontYo = yo(zo >= 0);
    % plot_streaks(frontXo, frontYo, outercolor);
    scatter(frontXo, frontYo, 10, outercolor, 'filled', 'SizeData', dotsize);
    ...
    plot_streaks(frontX, frontY, color);
    plot_streaks(frontXo, frontYo, outercolor);
    exportgraphics(gcf,'streaks.eps','ContentType','vector')
